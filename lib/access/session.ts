 ...
 *
 * Écrite en JavaScript pur plutôt qu'avec `node:crypto` : ce module est importé
 * par le middleware Edge. Un `===` sortirait au premier caractère différent, ce
 * qui laisse deviner un jeton caractère par caractère à la mesure du temps de
 * réponse. La longueur reste observable — elle ne suffit pas à reconstituer un
 * secret.
 */
