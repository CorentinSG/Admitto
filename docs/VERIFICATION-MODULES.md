# Vérification des sections officielles des modules

> Pendant du `docs/VERIFICATION-REGLES.md`, appliqué à la pédagogie. Une section
...
termine explicitement sur le fait que rien de ce qui précède ne préjuge de ce
que le Board décidera d'un dossier donné.
