...
| **Timeline interactive** | Les tâches datées projetées sur l'axe du temps : accompli, en retard, échéance qui approche (pulsation), repère du jour, sélection au clic reliée à l'outil de la tâche ; avance mécaniquement avec les statuts de la feuille de route | **Fait** |
